...
/**
 * <code>ErrorHandler</code> implements a very simple error handling policy.
 * The location and type of error is displayed on the standard output and
 * every error is signalled as a fatal error back to the caller.
 */
class ErrorHandler implements cip.byteinputlexer.ErrorHandler {
